...
pi=3.141592
valvec=np.logspace(-20,-13.5,1000)
...
ax2 = ax.twiny()
#ax2.plot(t, s2, 'r.')
ax2.plot(valvec,appampvec,color="red",label="Approximate",lw=0)
ax2.set_xlabel(r"$\lambda_2$ (eV)")
...
ax.set_xlabel(r"$\lambda_2/\Delta$ (eV/eV)")
