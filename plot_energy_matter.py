...
data=np.load('energy_matter.npz')
...
axes[0].set_xlim([xax_vector[0],5e1])
...
axes[1].set_xlim([xax_vector[0],5e1])
...
axes[0].text(0.25, 0.385, textstr, transform=axes[0].transAxes, fontsize=16,verticalalignment='top', bbox=props)
