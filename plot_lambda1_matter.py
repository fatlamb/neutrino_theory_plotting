...
data=np.load('lambda1_matter.npz')
...
axes[2].set_xlabel(r"$\lambda_1/\Delta$ [TeV/TeV]")
...
for ax in enumerate(single_axis):
	...
	#legends.append(ax[1].legend(bbox_to_anchor=(0.72, 0.365),
    #       bbox_transform=plt.gcf().transFigure, shadow=False,fancybox=True))
